...
gene_embedding_path="/volume1/home/pxie/data/embeddings/fused_embedding.pkl"
...
ctm.save(model_dir=f'./results/checkpoints/',part_name=f"{model_name}_2_part1")
...
df_topics_per_cell1.to_csv(output_file, index=True)
...
ctm.save(model_dir=f'./results/checkpoints/',part_name=f"{model_name}_2_part2")
...
df_topics_per_cell2.to_csv(output_file, index=True)