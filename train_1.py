...
ctm.save(model_dir=f'./results/checkpoint/',part_name=f"{model_name}_1_part1")
...
output_file = f"/volume1/home/pxie/topic_model/solution4/results/{model_name}_1_PBMC_t{num_topics}_c.csv"
...
prior_mean,prior_variance=ctm.fit(train_dataset2,patience=10)
ctm.save(model_dir=f'./results/checkpoint/',part_name=f"{model_name}_1_part2")
...
output_file = f"/volume1/home/pxie/topic_model/solution4/results/{model_name}_1_Cortex_t{num_topics}_c.csv"
